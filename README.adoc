...
La force de trainée vaut en moyenne 6.12 et la force de portance vaut en moyenne 0 (LibreOffice ne permet pas la précision nécessaire pour avoir un résultat plus fin). 
